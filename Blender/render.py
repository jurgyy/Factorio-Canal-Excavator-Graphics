...
def renderShadows():
    setMainAnimationStartEndFrame()
    #hideEverythingBut(objName="Shadow Catcher", colName=["Main Render", "Drop"])
    setCollectionRayVisibility(bpy.data.collections["Main Render"], False)
    #setCollectionRayVisibility(bpy.data.collections["Drop"], False)
    ...
    #setCollectionRayVisibility(bpy.data.collections["Drop"], True)
